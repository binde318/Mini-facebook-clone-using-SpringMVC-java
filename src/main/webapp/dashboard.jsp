...
<%@ page import="com.example.facebookclone.models.User" %>
<%@ page import="com.example.facebookclone.models.Posts" %>
<%@ page import="java.util.List" %>
<%@ page import="com.example.facebookclone.dao.DashboardDAO" %><%--
